...
export default function Command() {
    ...
    function getUrl(type : "ms" | "qp") : string {
        let str = `https://pastpapers.papacambridge.com/directories/CAIE/CAIE-pastpapers/upload/${codeStruct?.subjectCode}_${codeStruct?.cat}${codeStruct?.year}_${type}_${codeStruct?.varienat}.pdf#view=FitH`
        console.log(str)
        return str
    }
